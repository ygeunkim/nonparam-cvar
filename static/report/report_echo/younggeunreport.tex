...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/lossdist-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/lossquantile-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/wdkllnormal-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/wdkllboundary-1} 
...
\NormalTok{xcond <{-}}\StringTok{ }\KeywordTok{seq\_len}\NormalTok{(N) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{N)}
\NormalTok{mc <{-}}\StringTok{ }
\StringTok{  }\KeywordTok{lapply}\NormalTok{(}
    \DecValTok{1}\OperatorTok{:}\NormalTok{M,}
    \ControlFlowTok{function}\NormalTok{(i) \{}
\NormalTok{      X <{-}}\StringTok{ }\KeywordTok{ugarchpath}\NormalTok{(arch, }\DataTypeTok{n.sim =}\NormalTok{ N)}\OperatorTok{@}\NormalTok{path}
\NormalTok{      X <{-}}\StringTok{ }\KeywordTok{do.call}\NormalTok{(}\StringTok{"cbind"}\NormalTok{, X)[,}\OperatorTok{{-}}\DecValTok{3}\NormalTok{]}
...
\StringTok{        }\NormalTok{.[,}
\NormalTok{          mc }\OperatorTok{:}\ErrorTok{=}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"s"}\NormalTok{, i)]}
\NormalTok{    \}}
\NormalTok{  ) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{rbindlist}\NormalTok{() }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\NormalTok{.[,}
\NormalTok{    xt }\OperatorTok{:}\ErrorTok{=}\StringTok{ }\NormalTok{xcond,}
\NormalTok{    by =}\StringTok{ }\NormalTok{mc] }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\NormalTok{.[,}
\NormalTok{    yt }\OperatorTok{:}\ErrorTok{=}\StringTok{ }\NormalTok{ar0 }\OperatorTok{+}\StringTok{ }\NormalTok{ar1 }\OperatorTok{*}\StringTok{ }\NormalTok{xt }\OperatorTok{+}\StringTok{ }\NormalTok{garch]}
\CommentTok{\# true ces{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{sig <{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(mc}\OperatorTok{$}\NormalTok{sigma)}
\NormalTok{mc }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\NormalTok{.[,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{test\_err <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(band) \{}
\NormalTok{  mc }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{    }\NormalTok{.[,}
\NormalTok{      .(}\DataTypeTok{pred\_ces =} \KeywordTok{wdkll\_ces}\NormalTok{(yt }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{xt, }\DataTypeTok{data =}\NormalTok{ .SD, }\DataTypeTok{nw\_h =}\NormalTok{ band, }\DataTypeTok{h0 =}\NormalTok{ band }\OperatorTok{/}\StringTok{ }\DecValTok{10}\NormalTok{) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{          }\KeywordTok{predict}\NormalTok{(mc\_test}\OperatorTok{$}\NormalTok{xt),}
        \DataTypeTok{pred\_wnw =} \KeywordTok{wnw\_ces}\NormalTok{(yt }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{xt, }\DataTypeTok{data =}\NormalTok{ .SD, }\DataTypeTok{nw\_h =}\NormalTok{ band, }\DataTypeTok{h0 =}\NormalTok{ band }\OperatorTok{/}\StringTok{ }\DecValTok{10}\NormalTok{) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{          }\KeywordTok{predict}\NormalTok{(mc\_test}\OperatorTok{$}\NormalTok{xt, }\DataTypeTok{nw =} \OtherTok{TRUE}\NormalTok{),}
        \DataTypeTok{ces =}\NormalTok{ mc\_test}\OperatorTok{$}\NormalTok{true\_ces),}
\NormalTok{      by =}\StringTok{ }\NormalTok{mc] }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{    }\NormalTok{.[,}
      \StringTok{\textasciigrave{}}\DataTypeTok{:=}\StringTok{\textasciigrave{}}\NormalTok{(}
        \DataTypeTok{abs\_err\_ces =} \KeywordTok{abs}\NormalTok{(ces }\OperatorTok{{-}}\StringTok{ }\NormalTok{pred\_ces),}
        \DataTypeTok{abs\_err\_wnw =} \KeywordTok{abs}\NormalTok{(ces }\OperatorTok{{-}}\StringTok{ }\NormalTok{pred\_wnw)}
\NormalTok{      )] }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{    }\NormalTok{.[,}
\NormalTok{      .(}
        \DataTypeTok{abs\_err\_ces =} \KeywordTok{mean}\NormalTok{(abs\_err\_ces),}
        \DataTypeTok{abs\_err\_wnw =} \KeywordTok{mean}\NormalTok{(abs\_err\_wnw)}
\NormalTok{      ),}
\NormalTok{      by =}\StringTok{ }\NormalTok{mc]}
\NormalTok{\}}
\end{Highlighting}
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/wdkllnw-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/bitprice-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/bitreturn-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/cvarcoin-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/cvardji-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{/Users/younggeun/Documents/GitHub/nonparam-cvar/static/report/report_echo/younggeunreport_files/figure-latex/cesfit-1} 
